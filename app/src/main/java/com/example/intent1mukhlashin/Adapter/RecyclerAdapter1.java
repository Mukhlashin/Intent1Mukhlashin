...
import com.example.intent1mukhlashin.DetailActivity.ScrollingDetailActivity1;
import com.example.intent1mukhlashin.FragContainer.ContainerFragment1;
import com.example.intent1mukhlashin.R;

public class RecyclerAdapter1 extends RecyclerView.Adapter<ContainerFragment1> {
    ...
    public RecyclerAdapter1(Context context) {this.context = context;}

    @NonNull
    @Override
    public ContainerFragment1 onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.activity_scrolling_detail, null);
        return new ContainerFragment1(v, context);
    }

    @Override
    public void onBindViewHolder(@NonNull ContainerFragment1 containerFragment1, final int position) {
        containerFragment1.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent move = new Intent(context, ScrollingDetailActivity1.class);
                move.putExtra("nama", namaTempat[position]);
                move.putExtra("deskripsi", detail[position]);
                move.putExtra("gambar", gambarTempat[position]);
